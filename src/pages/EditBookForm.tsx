...
// const GENRE_OPTIONS = ["FICTION", "NON_FICTION", "SCIENCE", "HISTORY", "BIOGRAPHY", "FANTASY"] as const;
...
//         icon: "success",
//         title: "Book updated!",
//         text: `"${formData.title}" was successfully updated.`,
...
//         <div>
//           <Label>Genre</Label>
//           <select {...register("genre")} className="w-full border px-3 py-2 rounded">
//             {GENRE_OPTIONS.map((g) => (
...
//         <div>
//           <Label>Copies</Label>
//           <Input type="number" {...register("copies", { required: true })} defaultValue={book.copies} />
//         </div>
